...
var lyr_Espciesarbreas_4 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Espciesarbreas_4_5.png" /> -<br />'
        });
...
lyr_Espciesarbreas_4.set('fieldAliases', {'Arvore': 'Árvore', 'Família': 'Família', 'Nome cient': 'Nome científico', 'Nome popul': 'Nome popular', 'Fotos': 'Fotos', 'Observacoe': 'Observações', 'Classifica': 'Classificação', 'Coroamento': 'Coroamento', });
lyr_Pomarrea_2.set('fieldImages', {'id': 'TextEdit', });
lyr_Pomar_3.set('fieldImages', {'id': 'TextEdit', });
lyr_Espciesarbreas_4.set('fieldImages', {'Arvore': 'TextEdit', 'Família': 'TextEdit', 'Nome cient': 'TextEdit', 'Nome popul': 'TextEdit', 'Fotos': 'ExternalResource', 'Observacoe': 'TextEdit', 'Classifica': 'TextEdit', 'Coroamento': 'TextEdit', });
lyr_Pomarrea_2.set('fieldLabels', {'id': 'no label', });
lyr_Pomar_3.set('fieldLabels', {'id': 'no label', });
lyr_Espciesarbreas_4.set('fieldLabels', {'Arvore': 'header label - always visible', 'Família': 'header label - always visible', 'Nome cient': 'header label - always visible', 'Nome popul': 'header label - always visible', 'Fotos': 'no label', 'Observacoe': 'header label - always visible', 'Classifica': 'header label - always visible', 'Coroamento': 'header label - always visible', });
